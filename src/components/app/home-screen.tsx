...
export function HomeScreen() {
  ...
  return (
    <div className="flex flex-col gap-4 px-4 pb-4">
      ...
      {/* Bowel + Walk tracker (right after +1 button for maximum visibility) */}
        ...
        <Card className="p-3">
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              ...
              className="flex flex-col items-center gap-0.5 rounded-xl border-2 border-amber-500/40 bg-amber-500/5 p-2 transition-all hover:border-amber-500 hover:bg-amber-500/10"
            >
            ...
            {walkReminderEnabled && (
              <button
                ...
                className="flex flex-col items-center gap-0.5 rounded-xl border-2 border-green-500/40 bg-green-500/5 p-2 transition-all hover:border-green-500 hover:bg-green-500/10"
              >
                <span className="text-xl">🚶</span>
